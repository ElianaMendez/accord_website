...
BEGIN
    ...
    IF v_version = 'ACCORD-DIAG-1.1' THEN
        IF v_agg_questions IS NULL OR ARRAY_LENGTH(v_agg_questions, 1) != 19 THEN
            RAISE EXCEPTION 'Incomplete Diagnostic. Expected exactly 19 valid responses.';
        END IF;
        
        IF v_agg_questions != ARRAY[
            'AIA-17:ai_automation', 'AIA-18:ai_automation', 'AIA-19:ai_automation',
            'DEP-01:commercial_dependency', 'DEP-02:commercial_dependency', 'DEP-03:commercial_dependency',
            'GOV-20:governance_evolution', 'GOV-22:governance_evolution', 'GOV-23:governance_evolution',
            'INF-09:operational_infrastructure', 'INF-10:operational_infrastructure', 'INF-12:operational_infrastructure',
            ...
            'PRO-06:commercial_process', 'PRO-07:commercial_process', 'PRO-08:commercial_process'
        ] THEN
            RAISE EXCEPTION 'Diagnostic dimension map mismatch. Invalid, missing, duplicate or unmapped questions detected for version 1.1.';
        END IF;

    ELSIF v_version = 'ACCORD-DIAG-1.0' THEN
